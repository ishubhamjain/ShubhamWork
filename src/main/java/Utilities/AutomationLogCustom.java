...
public class AutomationLogCustom 
{
    private Logger logger = Logger.getLogger(AutomationLogCustom.class.getSimpleName());
    private static AutomationLogCustom automationLogInstance = null;
    private static FileHandler fh;  
    private AutomationLogCustom()
    {
    ...
    private static AutomationLogCustom getAutomationLog()
    {
        if (automationLogInstance == null)
        {
            automationLogInstance = new AutomationLogCustom();
        }
    ...
    {
        return AutomationLogCustom.getAutomationLog().logger;
    }
